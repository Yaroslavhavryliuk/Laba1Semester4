...
template<class T>
void listGeneralTypes(List<T>& lst)
{
...
template<class T>
void matrixGeneralTypes(Matrix<T>& matr)
{
	...
	Matrix<T> matr2(value2, matr.getRd(), matr.getSt());
...
template<class T>
void matrixMyTypes(Matrix<T>& matr)
{
	cout << "Lines: " << matr.getRd() << endl;
	cout << "-----------------------------------" << endl;
	cout << "Columns: " << matr.getSt() << endl;
